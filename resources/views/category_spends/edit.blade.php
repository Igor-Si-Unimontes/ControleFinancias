...
@section('content')
    <div class="container rounded bg-fosco shadow-sm mt-4 p-5">
        <h1 class="mb-2 titulo">Editar Categoria de Gasto</h1>
        <div class="divisor-underline mb-4"></div>
        <form action="{{ route('category_spends.update', $categorySpend->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
            ...
            <div class="d-flex justify-content-start gap-2 mt-3">
                ...
                <button type="submit" class="btn btn-success">Atualizar Categoria de Gasto</button>
            </div>
        </form>
    </div>
@endsection